...
window.CodeMirror = (function() {
  ...
  keyMap.pcDefault = {
    ...
    "Ctrl-[": "indentLess", "Ctrl-]": "indentMore","Shift-Ctrl-F" : "autoFormat", "Shift-Ctrl-C" : "comment", "Shift-Ctrl-I" : "unComment",
    fallthrough: "basic"
  };
  keyMap.macDefault = {
    ...
    "Cmd-G": "findNext", "Shift-Cmd-G": "findPrev", "Cmd-Alt-R": "replace", "Shift-Cmd-Alt-R": "replaceAll",
    "Cmd-[": "indentLess", "Cmd-]": "indentMore","Shift-Cmd-F" : "autoFormat", "Shift-Cmd-C" : "comment", "Shift-Cmd-I" : "unComment",
  ...
  keyMap.getCurrentKey = function(name, map){
	  for(var command in keyMap[map]) {
		  if(name==keyMap[map][command]) {
			  return command;
		  }
	  }
  };
