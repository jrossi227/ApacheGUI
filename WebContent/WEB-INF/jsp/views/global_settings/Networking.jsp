...
<div dojoType="dijit.layout.AccordionContainer" style="height: 100%">
	...
	<div title="Listening" dojoType="dijit.layout.ContentPane" id="listeningContainer">
	...
	<div title="Name Based Virtual Hosts" dojoType="dijit.layout.ContentPane" id="nameVirtualHostContainer">
	...
	<div title="Keep Alive" dojoType="dijit.layout.ContentPane" id="keepAliveContainer">
	...
	<div title="Request Settings" dojoType="dijit.layout.ContentPane" id="requestSettingsContainer">
	...
	<div title="Server Settings" dojoType="dijit.layout.ContentPane" id="serverSettingsContainer">
