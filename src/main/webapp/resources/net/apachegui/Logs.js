define([ "dojo/_base/declare",
    ...
    declare("net.apachegui.Logs", null,{
        ...
        updateSelection: function () {
            ...
            if(option=='search')
            {
                ...
                if(this.optionInit!=null && this.currOption!='search') {
                    window.location.href='Logs.jsp?file=' + net.apachegui.Util.getQueryParam('file') + '&option=search';
                }
            }
            if(option=='download')
            {
            ...
            if(option=='tail')
            {
                ...
                if(this.optionInit!=null && this.currOption!='tail') {
                    window.location.href='Logs.jsp?file=' + net.apachegui.Util.getQueryParam('file') + '&option=tail';
                }
            }
        ...
        search: function () {
            ...
            var thisdialog = net.apachegui.Util.noCloseDialog('Generating', 'Searching Please Wait...');
            thisdialog.show();
            ...
            request.get("../web/Logs", {
                ...
                function(error) {
                    thisdialog.remove();
                    net.apachegui.Util.alert('Info',error.response.data);
                }
            );
        },
        ...
        exportToFile: function () {
            var thisdialog = net.apachegui.Util.noCloseDialog('Generating', 'Generating File Please Wait...');
            thisdialog.show();
