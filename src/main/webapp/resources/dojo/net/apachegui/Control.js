define([ "dojo/_base/declare",
    ...
    declare("net.apachegui.Control", null, {
        ...
        setRefreshTimer: function() {
            net.apachegui.Interval.clearInterval ( this.refreshTimerHandler );
            
            //convert to milliseconds
            var refreshRate=(dom.byId('processInfoRefreshRate').value * 1000);
            if(refreshRate>0) {
                this.refreshTimerHandler = net.apachegui.Interval.setInterval(this.refreshProcessInfo.bind(this), refreshRate);    
            }
        },
                ...
                request.get("../web/Control", {
                    ...
                    function(response) {
                        ...
                        if(data.result==false) {
                            dom.byId('extendedStatusToggle').checked=false;
                            net.apachegui.Util.alert("status_module not available", "Turning on extended status requires that the status_module is loaded into apache.<BR/> This module is not currently loaded and is not in the available modules folder.");
                        }
                        else {
        ...
        extendedStatusRestartWarning: function ()  {
            ...
            {    
                ...
                {
                    net.apachegui.Util.alert("Turn On Extended Status", "Turning on extended status requires a server restart.<BR/> The server will restart after you submit this change!");
                }
            }
        },
        ...
        initProcessMenu: function() {
            var that=this;
            net.apachegui.Util.confirmDialog("Kill Process", "Do you want to kill process " + this.currentControlMenuId + "?", function confirm(conf) {
                    if(conf)
                    {
        ...
        killProcess: function(pid) {
            ...
            var thisdialog = net.apachegui.Util.noCloseDialog('Killing', 'Killing Process Please Wait...');
            thisdialog.show();
        ...
        startServer: function() {
            ...
            var thisdialog = net.apachegui.Util.noCloseDialog('Starting', 'Starting Please Wait...');
            thisdialog.show();
        ...
        restartServer: function() {
            ...
            var thisdialog = net.apachegui.Util.noCloseDialog('Restarting', 'Restarting Please Wait...');
            thisdialog.show();
        ...
        stopServer: function() {
            ...
            var thisdialog = net.apachegui.Util.noCloseDialog('Stopping', 'Stopping Please Wait...');
            thisdialog.show();
