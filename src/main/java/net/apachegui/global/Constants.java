...
public class Constants {
    ...
    public final static String runningProcessName = ".*httpd.*|.*apache2.*|.*apache\\..*";
    ...
    public final static String extendedStatusEnclosureTwoPointTwo = "<Location /server-status>" + Constants.newLine + "SetHandler server-status" + Constants.newLine + "Order deny,allow"
            ...
            + Constants.newLine;
    public final static String extendedStatusEnclosureTwoPointFour = "<Location /server-status>" + Constants.newLine + "SetHandler server-status" + Constants.newLine + "Require local"
            + Constants.newLine + "</Location>" + Constants.newLine + Constants.newLine;
