...
public class ServerSignature extends SingletonDirective {
	...
	/**
	 * Creates a ServerSignature object from the directive. 
	...
	/**
	 * Static function to get the current configured ServerSignature in apache.
	 * If there is no ServerSignature found then a ServerSignature is returned with value Off.
	 * 
	...
	/**
	 * Function to get the current configured ServerSignature in apache.
	 * If there is no ServerSignature found then a ServerSignature is returned with value Off.
	 * 
	 * @return a ServerSignature object, is no ServerSignature is found then a ServerSignature is returned with value Off.
	 * @throws Exception
	...
	public ServerSignature getConfigured() throws Exception {
		String serverSignature[]=new DirectiveParser(Settings.getSetting(Constants.confFile), Settings.getSetting(Constants.serverRoot), StaticModuleHandler.getStaticModules(), SharedModuleHandler.getSharedModules()).getDirectiveValue(directiveName);
