...
public class Listen extends FactoryDirective {
	...
	/**
	 * Takes an apache Listen directive String and creates a Listen object. The String must conform
	 * to the following format:
	 * 
	 * [IP-address:]portnumber [protocol]
	 * 
	 * @param directiveValue - A String with a valid apache Listen directive  value
	 */
	 ...
	 * 
	 * @param ip - A string with an ip address.
	 * @param port - An integer with a valid port.
	 * @param protocol - A string with a protocol
	 */
	...
	public boolean equals(Object listener) 
	{
		...
		if(this.ip.equals(target.getIp()) && 
		   this.port == target.getPort() && 
		   this.protocol.equals(target.getProtocol())) {
			return true;
		}
