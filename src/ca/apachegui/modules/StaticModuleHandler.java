...
public class StaticModuleHandler extends ModuleHandler{
	...
	/**
	 * Gets a list of all statically loaded modules. These modules compiled into apache. 
	 * These modules can never change so we only look them up once per server load.
	 * 
