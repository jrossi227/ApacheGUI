 ...
 * eg. AddType application/x-gzip gz tgz
 * 
 *
 */
public class AddedMime extends Mime {
	 ...
	 * 
	 * @param mime - The mime to add to the configuration.
	 * @throws Exception if a MIME currently exists with the same type.
	 */
	 ...
	 * 
	 * @param mime - The mime to edit.
	 * @throws Exception if there is no MIME found with the current type
	 */
