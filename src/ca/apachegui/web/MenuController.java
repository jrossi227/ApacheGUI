...
public class MenuController {
	...
	public String renameFile(@RequestParam(value="oldFile") String oldFile,
							 @RequestParam(value="newFile") String newFile) throws Exception {
	...
	public String newFile(@RequestParam(value="filename") String filename,
	...
	public String cut(@RequestParam(value="oldFile") String oldFile,
					  @RequestParam(value="directory") String directory) throws Exception {
	...
	public String copy(@RequestParam(value="oldFile") String oldFile,
					   @RequestParam(value="directory") String directory) throws Exception {
	...
	public String submitSearch(@RequestParam(value="searchFilter") String filter,
							   @RequestParam(value="searchFileList") String fileList,
							   @RequestParam(value="searchRecursively") String searchRecursively,
							   @RequestParam(value="searchDirectory") String directory) {
