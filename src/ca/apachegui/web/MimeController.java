...
public class MimeController {
	...
	public String addMime(@RequestParam(value="type") String type,
					      @RequestParam(value="extensions") String extensions) throws Exception {
	...
	public String editMime(@RequestParam(value="type") String type,
						   @RequestParam(value="extensions") String extensions) throws Exception {
	...
	public String removeMime(@RequestParam(value="type") String type,
							 @RequestParam(value="extensions") String extensions) throws Exception {
